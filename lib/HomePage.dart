...
class _HomePageState extends State<HomePage> {
  ...
  void startGame() {
    if (preGame) {
      ...
      audioInGame = new AudioCache(prefix: 'assets/pacman_beginning.wav');
      audioPaused = new AudioCache(prefix: 'assets/pacman_chomp.wav');
      ...
      Timer.periodic(Duration(milliseconds: 170), (timer) {
        ...
        if (food.contains(player)) {
          audioMunch.load('pacman_chomp.wav');
          setState(() {
            food.remove(player);
          });
          score++;
                        ...
                        if (!paused)
                          {
                            ...
                            audioPaused.load('pacman_intermission.wav'),
                          }
                        else
                          {
                            paused = false,
